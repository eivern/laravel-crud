<x-layout>
    ...
    <section x-data="{ open: false }" class="p-8">
        <button @click="open = !open" x-text="open? 'Tutup' : 'Buka'" x-bind:class="open ? 'bg-red-600' : 'bg-green-600'"
            type="button"
            class="mb-2 me-2 rounded-full px-5 py-2.5 text-center text-sm font-medium text-white focus:outline-none focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Buka</button>
                    ...
                    <table class="w-full text-left text-sm text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            <tr class="border-b dark:border-gray-700">
                                <th scope="row"
                                    class="whitespace-nowrap px-4 py-3 font-medium text-gray-900 dark:text-white">Apple
                                    iMac 27&#34;</th>
                            ...
                            <tr class="border-b dark:border-gray-700">
                                <th scope="row"
                                    class="whitespace-nowrap px-4 py-3 font-medium text-gray-900 dark:text-white">Xbox
                                    Series S</th>
                            ...
                            <tr class="border-b dark:border-gray-700">
                                <th scope="row"
                                    class="whitespace-nowrap px-4 py-3 font-medium text-gray-900 dark:text-white">NIKON
                                    D850</th>
