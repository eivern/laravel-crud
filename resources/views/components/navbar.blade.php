        ...
        <div class="flex h-16 items-center justify-between">
                ...
                <div class="ml-4 flex items-center md:ml-6">
                    ...
                    <div class="relative ml-3">
                        ...
                        <div class="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black/5 focus:outline-none"
                            ...
                            <a class="block px-4 py-2 text-sm text-gray-700" id="user-menu-item-0" href="#"
                                role="menuitem" tabindex="-1">Your Profile</a>
                            <a class="block px-4 py-2 text-sm text-gray-700" id="user-menu-item-1" href="#"
                                role="menuitem" tabindex="-1">Settings</a>
                            <a class="block px-4 py-2 text-sm text-gray-700" id="user-menu-item-2" href="#"
            ...
            <div class="-mr-2 flex md:hidden">
                ...
                <button
                    ...
                    <svg class="size-6 block" data-slot="icon" aria-hidden="true"
                        :class="{ 'hidden': isOpen, 'block': !isOpen }" fill="none" viewBox="0 0 24 24"
                        stroke-width="1.5" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round"
                            d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5" />
                    </svg>
                    <!-- Menu open: "block", Menu closed: "hidden" -->
                    <svg class="size-6 hidden" data-slot="icon" aria-hidden="true"
                        :class="{ 'block': isOpen, 'hidden': !isOpen }" fill="none" viewBox="0 0 24 24"
                        stroke-width="1.5" stroke="currentColor">
